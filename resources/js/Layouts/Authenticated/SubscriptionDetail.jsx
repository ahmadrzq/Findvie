...
export default function SubscriptionDetail({
    ...
    return (
        <>
                ...
                <div className="mt-auto pr-[30px]">
                    <div className="p-5 bg-white rounded-[25px] outline outline-1 outline-[#f1f1f1]">
                        ...
                        <div className="rounded-full w-full h-[6px] bg-[#f1f1f1]">
                            <div className={`rounded-full h-full bg-teal-700 ${loadingProgress()}`}></div>
                        </div>
                    </div>
                </div>
            )}
            ...
            {isPremium && (
                <div className="mt-auto pr-[30px]">
                    <div className="p-5 bg-black rounded-[25px] outline outline-1 outline-black">
                        <div className="bg-teal-700 rounded-full p-[13px] max-w-max mb-4">
                        ...
                        <div className="rounded-full w-full h-[6px] bg-[#f1f1f1]">
                            <div className="rounded-full h-full w-2/12 bg-teal-700"></div>
                        </div>
                    </div>
                </div>
            )}
